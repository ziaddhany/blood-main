...
class clinic_profile extends StatefulWidget {
  const clinic_profile({super.key});

  @override
  State<clinic_profile> createState() => _clinic_profileState();
}

class _clinic_profileState extends State<clinic_profile> {
  @override
